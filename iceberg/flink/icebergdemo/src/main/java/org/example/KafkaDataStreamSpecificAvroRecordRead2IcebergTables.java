...
public class KafkaDataStreamSpecificAvroRecordRead2IcebergTables {
    ...
    public static void main(String[] args) throws Exception {
        ...
        flinkWritesJob.write(kafkaSource, FlinkDataStreamAvroWritesWithSchema.getAvroSchema("StockTicks.avsc"));
        ...
        flinkWritesJob2.write(kafkaSource, FlinkDataStreamAvroWritesWithSchema.getAvroSchema("StockTicks.avsc"));
